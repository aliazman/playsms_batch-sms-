...
function webservices_pv_batch($c_username, $sms_to, $sms_msg, $type = 'text', $unicode = 0, $nofooter = FALSE, $footer = '', $from = '', $schedule = '') {
	...
	$db_query .= "VALUES (4,'$sid','" . core_get_datetime() . "','$smsto','" . addslashes($msg) . "','$c_username')";
